    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(intent.getAction().equals(PoolAdapter.BROADCAST_DATVE)){
                ...
                if(intent.getAction().equals(BOADCAST_PREPARED_DATA)){
                    mPoolAdapter = new PoolAdapter(MainActivity.this,mPools);
                    mListView.setAdapter(mPoolAdapter);
                }
            }
        };
        IntentFilter mFilter = new IntentFilter();
        mFilter.addAction(network.INTENT_INFO_JSON_DATA);
        mFilter.addAction(PoolAdapter.BROADCAST_DATVE);
